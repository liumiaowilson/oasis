...
nohup $wikiAppHome/tiddlywiki.js $gtdData --load $appHome/cardo.html --server $port $:/core/save/lazy-images text/plain text/html "$gtd_username" "$gtd_password" 0.0.0.0 > $log 2>&1 &
